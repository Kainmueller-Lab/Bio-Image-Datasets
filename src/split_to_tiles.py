...
def transform_to_tiles(
    ...
    for i in range(n_tiles_y):
        for j in range(n_tiles_x):
            ...
            if padding != PaddingType.NONE and (arr_tile.shape[0] < tile_size or arr_tile.shape[1] < tile_size):
                arr_tile = cv2.resize(arr_tile, (tile_size, tile_size))
