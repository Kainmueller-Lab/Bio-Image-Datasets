...
class TestLizardDataset(unittest.TestCase):
    ...
    def test_get_he(self):
        ...
        self.assertTrue(
            np.max(image) <= 255 and np.min(image) >= 0,
    ...
    def test_get_instance_mask(self):
        ...
        self.assertTrue(
            ...
            "Instance mask should contain at least one instance.",
        )
        self.assertTrue(
            np.all(unique_instances >= 0),
    ...
    def test_get_sample_names(self):
        ...
        self.assertEqual(
            len(sample_names),
            self.total_samples,
            "Number of sample names should match dataset length.",
        )
        self.assertTrue(
            all(isinstance(name, str) for name in sample_names),
            "All sample names should be strings.",
        )
    ...
    def test_get_item(self):
        ...
        self.assertTrue(
            ...
            "Sample dictionary should contain all expected keys.",
        )
        # Test image
        image = sample["image"]
        self.assertIsInstance(image, np.ndarray, "Image should be a NumPy array.")
    ...
    def test_load_label(self):
        ...
        self.assertTrue(
            expected_keys.issubset(label_data.keys()),
            "Label data should contain all expected keys.",
        )
        # Test inst_map
